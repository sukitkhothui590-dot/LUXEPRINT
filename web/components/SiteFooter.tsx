...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-white/10 bg-black pt-28 pb-12 text-stone-300 md:pt-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="md:col-span-1">
            <Link href="/">
              <span className="mb-6 block cursor-pointer text-2xl font-semibold uppercase tracking-[0.16em] text-white">
                LuxePrint
              </span>
            </Link>
          ...
          <div>
            <p className="mb-6 text-[11px] font-medium uppercase tracking-[0.22em] text-stone-500">
              เมนูหลัก
            </p>
        ...
        <div className="flex flex-col items-center justify-between border-t border-white/10 pt-8 md:flex-row">
          <p className="text-xs text-stone-500">
            © 2026 LuxePrint Inkjet. All rights reserved.
          </p>
          <div className="mt-4 flex space-x-4 text-xs text-stone-500 md:mt-0">
